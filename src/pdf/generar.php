...
$pdf->Ln();
//$pdf->image("assets/img/icon.jpg", 60, 15, 15, 15, 'JPG');
...
$pdf->Cell(22, 5, utf8_decode('Nombre'), 0, 0, 'L');
$pdf->Cell(16, 5, utf8_decode('Teléfono'), 0, 0, 'L');
$pdf->Cell(20, 5, utf8_decode('Dirección'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 7);
$pdf->Cell(22, 5, utf8_decode($datosC['nombre']), 0, 0, 'L');
$pdf->Cell(16, 5, utf8_decode($datosC['telefono']), 0, 0, 'L');
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(65, 5, 'Total Pagar', 1, 1, 'R');
$pdf->SetFont('Arial', '', 10);
