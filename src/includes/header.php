...
<head>
    ...
    <link rel="shorcut icon" type="image/x-icon" href="../assets/img/icon.jpg"/>
    <title>Farmacias AGM    |   Panel</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand " href="javascript:;">Panel de Administracion</a>
                        <span style="padding-left:620px;"><?php echo fecha(); ?></span>  
                    </div>
